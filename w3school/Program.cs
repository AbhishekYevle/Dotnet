...
namespace program
{
  class prac1
  {
    ...
    public static void Example1234()
    {
      Console.WriteLine("Hii Im robot");
    }
    //method parameter
  ...
  class sample
  {
    public static void Example12345()
    {
      Console.WriteLine("Hii Im robot");
    }
  }
...
namespace iiiii
{
  class sample2
  {
    public static void Example1234()
    {
      Console.WriteLine("Hii Im robot 2");
    }
  }
}
